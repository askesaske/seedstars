...
@font-face {
  ...
  src: local("☺"), url("../assets/fonts/BebasNeue-Regular.woff") format("woff"),
...
@font-face {
  ...
  src: local("☺"), url("../assets/fonts/Oswald-Regular.woff") format("woff"),
...
@font-face {
  ...
  src: local("☺"), url("../assets/fonts/Oswald-Bold.woff") format("woff"),
...
@font-face {
  ...
  src: local("SF Pro Display Medium"), local("SFProDisplay-Medium"),
    url("../assets/fonts/SFProDisplay-Medium.eot?#iefix")
...
@font-face {
  ...
  src: local("SF Pro Display Regular"), local("SFProDisplay-Regular"),
    url("../assets/fonts/SFProDisplay-Regular.eot?#iefix")
      format("embedded-opentype"),
...
@font-face {
  ...
  src: local("☺"), url("../assets/fonts/Gotham Pro Regular.woff") format("woff"),
...
@font-face {
  ...
  src: local("☺"), url("../assets/fonts/Gotham Pro Bold.woff") format("woff"),
